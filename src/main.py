...
cursor.execute('SELECT * FROM rating WHERE "userId" < 100')
...
print(content_r.generate_recommendations(99, 10, True)
      [["name", "genre", "relevance_score"]])
print(content_r.user_embeddings[99])

collab_r = CollabRecommender(anime_df, watched_ratings)
print(collab_r.generate_recommendations(99, 10, True)
      [['name', 'genre', "predicted_rating"]])

hybrid_r = HybridRecommender(anime_df, watched_ratings, content_r, collab_r)
print(hybrid_r.generate_recommendations(99, 10, True)[
